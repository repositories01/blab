...
const shouldUseNativeCodeLoading = getenv_1.boolish('EXPO_WEBPACK_USE_NATIVE_CODE_LOADING', true);
const shouldUseReactRefresh = getenv_1.boolish('EXPO_WEBPACK_FAST_REFRESH', false);
...
async function default_1(env, argv = {}) {
    ...
    if (isNative) {
        const reactNativeModulePath = config_1.projectHasModule('react-native', env.projectRoot, (_a = env.config) !== null && _a !== void 0 ? _a : {});
        if (reactNativeModulePath) {
            for (const polyfill of [
                ...
                const resolvedPolyfill = config_1.projectHasModule(`react-native/Libraries/${polyfill}`, env.projectRoot, (_b = env.config) !== null && _b !== void 0 ? _b : {});
                if (resolvedPolyfill)
    ...
    const ensureSourceAbsolute = (input) => {
        if (!input)
            return input;
        return Object.assign(Object.assign({}, input), { src: locations.absolute(input.src) });
    };
    // TODO(Bacon): Move to expo/config - manifest code from XDL Project
    const publicConfig = Object.assign(Object.assign({}, config), { xde: true, developer: {
            tool: 'expo-cli',
    ...
    let webpackConfig = {
        ...
        context: isNative ? (_c = env.projectRoot) !== null && _c !== void 0 ? _c : __dirname : __dirname,
        ...
        plugins: [
            ...
            generatePWAImageAssets &&
                new plugins_1.ApplePwaWebpackPlugin({
                    ...
                    name: (_d = env.config.web) === null || _d === void 0 ? void 0 : _d.shortName,
                    isFullScreen: (_e = env.config.web) === null || _e === void 0 ? void 0 : _e.meta.apple.touchFullscreen,
                    isWebAppCapable: (_f = env.config.web) === null || _f === void 0 ? void 0 : _f.meta.apple.mobileWebAppCapable,
                    barStyle: (_g = env.config.web) === null || _g === void 0 ? void 0 : _g.meta.apple.barStyle,
