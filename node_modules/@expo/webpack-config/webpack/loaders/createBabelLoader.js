...
function createBabelLoader(_a = {}) {
     ...
     */
    mode, projectRoot: inputProjectRoot, babelProjectRoot, include = [], verbose, platform = 'web', useCustom } = _a, options = __rest(_a, ["mode", "projectRoot", "babelProjectRoot", "include", "verbose", "platform", "useCustom"]);
    ...
    if (!fs_extra_1.default.existsSync(path_1.default.join(projectRoot, 'babel.config.js')) &&
        ...
        const modulePath = config_1.projectHasModule('babel-preset-expo', projectRoot, {});
        if (modulePath) {
            presetOptions = {
                babelrc: false,
                configFile: false,
    ...
    presetOptions = Object.assign(Object.assign(Object.assign({}, presetOptions), (customUseOptions || {})), { sourceType: 'unambiguous', root: ensuredProjectRoot, compact: isProduction, 
        ...
        sourceMaps: shouldUseSourceMap, inputSourceMap: shouldUseSourceMap });
