...
async function bundleAsync(projectRoot, options, bundles) {
    ...
    const buildAsync = async (bundle) => {
        var _a, _b, _c, _d;
        const bundleOptions = Object.assign(Object.assign({}, Server.DEFAULT_BUNDLE_OPTIONS), { bundleType: 'bundle', platform: bundle.platform, entryFile: bundle.entryPoint, dev: (_a = bundle.dev) !== null && _a !== void 0 ? _a : false, minify: (_b = bundle.minify) !== null && _b !== void 0 ? _b : false, inlineSourceMap: false, sourceMapUrl: bundle.sourceMapUrl, createModuleIdFactory: config.serializer.createModuleIdFactory, onProgress: (transformedFileCount, totalFileCount) => {
                if (!options.quiet) {
                    reporter.update({
                        buildID,
