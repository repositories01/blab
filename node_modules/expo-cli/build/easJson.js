...
const AndroidManagedSchema = _joi().default.object({
  ...
  credentialsSource: _joi().default.string().valid('local', 'remote', 'auto').default('auto'),
  buildType: _joi().default.string().valid('apk', 'app-bundle')
});
...
class EasJsonReader {
  ...
  async readAsync(buildProfileName) {
    ...
    if (['android', 'all'].includes(this.platform)) {
      ...
      androidConfig = this.validateBuildProfile(_buildTools().Platform.Android, buildProfileName, (_easJson$builds = easJson.builds) === null || _easJson$builds === void 0 ? void 0 : (_easJson$builds$andro = _easJson$builds.android) === null || _easJson$builds$andro === void 0 ? void 0 : _easJson$builds$andro[buildProfileName]);
    }
    ...
    if (['ios', 'all'].includes(this.platform)) {
      ...
      iosConfig = this.validateBuildProfile(_buildTools().Platform.iOS, buildProfileName, (_easJson$builds2 = easJson.builds) === null || _easJson$builds2 === void 0 ? void 0 : (_easJson$builds2$ios = _easJson$builds2.ios) === null || _easJson$builds2$ios === void 0 ? void 0 : _easJson$builds2$ios[buildProfileName]);
    }
