...
function applyWebDefaults(appJSON) {
    ...
    const { appName, webName } = config_1.getNameFromConfig(appJSON);
    const languageISOCode = webManifest.lang || DEFAULT_LANGUAGE_ISO_CODE;
    const buildOutputPath = config_1.getWebOutputPath(appJSON);
